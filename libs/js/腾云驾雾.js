var rule = {
    title:'腾云驾雾(新版)',
    host:'https://v.qq.com',
    homeUrl:'/tv-series-list/v-index.html?filter_params=sort%3D75&page_id=channel_list_second_page&channel_id=100173&page=1',
    detailUrl:'https://node.video.qq.com/x/api/float_vinfo2?cid=fyid',
    searchUrl:'/x/search/?q=**&stag=fypage',
    searchable:2,
    filterable:1,
    multi:1,
    url:'/tv-series-list/v-index.html?filter_params=sort%3D{{fl.sort||75}}&page_id=channel_list_second_page&channel_id={{fl.cid}}&page=((fypage))',
    filter_url:'',
    filter:{
'choice': [
...
'tv': [
    ...
    {'key':'cid','name':'分类ID','value':[{"n":"电视剧","v":"100113"}]},
    {'key': 'pay', 'name': '资费', 'value': [
        {'n': '全部', 'v': '-1'},
        {'n': '免费', 'v': '867'},
        {'n': '会员', 'v': '6'}
...
'movie': [
    ...
    {'key':'cid','name':'分类ID','value':[{"n":"电影","v":"100173"}]},
    {'key': 'pay', 'name': '资费', 'value': [
        {'n': '全部', 'v': '-1'},
        {'n': '免费', 'v': '867'},
        {'n': '会员', 'v': '6'}
...
'variety': [
    ...
    {'key':'cid','name':'分类ID','value':[{"n":"综艺","v":"100109"}]},
    {'key': 'pay', 'name': '资费', 'value': [
        {'n': '全部', 'v': '-1'},
        {'n': '免费', 'v': '867'},
        {'n': '会员', 'v': '6'}
...
'cartoon': [
    ...
    {'key':'cid','name':'分类ID','value':[{"n":"动漫","v":"100119"}]},
    {'key': 'pay', 'name': '资费', 'value': [
        {'n': '全部', 'v': '-1'},
        {'n': '免费', 'v': '867'},
        {'n': '会员', 'v': '6'}
...
'child': [
    ...
    {'key':'cid','name':'分类ID','value':[{"n":"少儿","v":"100150"}]},
    {'key': 'pay', 'name': '资费', 'value': [
        {'n': '全部', 'v': '-1'},
        {'n': '免费', 'v': '867'},
        {'n': '会员', 'v': '6'}
...
'doco': [
    ...
    {'key':'cid','name':'分类ID','value':[{"n":"纪录片","v":"100105"}]},
    {'key': 'pay', 'name': '资费', 'value': [
        {'n': '全部', 'v': '-1'},
        {'n': '免费', 'v': '867'},
        {'n': '会员', 'v': '6'}
...
'education': [
    ...
    {'key':'cid','name':'分类ID','value':[{"n":"教育","v":"110617"}]},
    {'key': 'pay', 'name': '资费', 'value': [
        {'n': '全部', 'v': '-1'},
        {'n': '免费', 'v': '867'},
        {'n': '会员', 'v': '6'}
    ...
    timeout:5000,
    cate_exclude:'会员|游戏|全部|NBA|科技',
    class_name:'精选&电视剧&电影&综艺&动漫&少儿&纪录片&教育',
    class_url:'choice&tv&movie&variety&cartoon&child&doco&education',
    limit:20,
    lazy:'js:input="https://cache.json.icu/home/api?type=ys&uid=292796&key=fnoryABDEFJNPQV269&url="+input.split("?")[0];log(input);let html=JSON.parse(request(input));log(html);input=html.url||input',
    推荐:'.list_item_v;img&&alt;img&&src;a&&Text;a&&href',
    一级:'.list_item_v;img&&alt;img&&src;a&&Text;a&&href',
